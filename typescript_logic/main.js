...
function parseAndRouteCommand(userInput) {
    ...
    if (/\b(transaction|tx|check|txid|trans)\b/.test(userInput)) {
        ...
        (0, identify_1.cmdIdentify)(args.slice(1)); // Pass the transaction hash to cmdIdentify
    }
    // Check for wallet-related keywords
        ...
        var args = userInput.split(" ");
        (0, wallet_1.cmdWallet)(args.slice(1)); // Pass the wallet address to cmdWallet
    }
    // Unknown command
    else {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            return readline.question("> ", resolve);
                        })];
                case 2:
                    userInput = _a.sent();
                    // Exit condition
...
main().catch(function (error) { return console.error("Error: ".concat(error)); });
